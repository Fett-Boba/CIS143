...
public class ToucheBetter {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ToucheBetter window = new ToucheBetter();
	...
	private void initialize() {
		...
		btnTournamentOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Generate Tournament related content
				...
				//Set the content areas above to visible = false
				//Then set them to be true here based on the # of fencers	
				
				
				
//				// Generate fencer numbers and names  
//				JTextField [] txtFencers  = new JTextField[8] ;
//				JLabel [] lblFencerNums = new JLabel[8];
//				for (int i = 0; i < 8; i++) {			
//					txtFencers[i] = new JTextField(15);
